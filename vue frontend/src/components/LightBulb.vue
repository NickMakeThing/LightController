<template>
    <div id='lightbulb-container'>
        <svg id="lightbulb" height="300px" viewBox="0 0 512 512" >
            <path :fill='lightbulbColor' d="M326,368c7.75,0,14,6.25,14,14s-6.25,14-14,14H186c-7.75,0-14-6.25-14-14s6.25-14,14-14H326
                M326,410c7.75,0,14,6.25,14,14s-6.25,14-14,14H186c-7.75,0-14-6.25-14-14s6.25-14,14-14H326
                M312,452c0,15.469-12.531,28-28,28h-56c-15.469,0-28-12.531-28-28H312
                M256,0C161.156,0,84,77.156,84,172c0,47.625,15.563,74.969,29.25,99.125c11.625,20.438,21.688,38.156,25.281,71.094c0.344,7.313,2.438,14.188,5.844,20.219
            ...
            <path fill='black' d="M256,32c77.313,0,140,62.688,140,140c0,76.125-45.875,85-54.5,168c0,7.75-6.25,14-14,14h-143c-7.75,0-14-6.25-14-14h-0.031
        ...
        <!-- <img height='300' id='lightbulb' alt="light bulb" src="../assets/lightbulb.svg"> -->
        <div id='lightbulb-fill' :style='lightbulbColor'></div>
    </div>
</template>
